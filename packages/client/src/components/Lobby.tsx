...
import type { Player, RoomSummary } from '@gamengine/shared'
...
export function Lobby({ socket }: LobbyProps) {
  ...
  function handleCreate() {
    ...
    setError(null)
    socket.emit('create_room', roomName.trim(), makePlayer(), (roomId) => {
              ...
              <li key={room.roomId} style={styles.roomItem}>
                ...
                <div style={styles.roomRight}>
                  ...
                  <button
                    style={{
                      ...styles.btnJoin,
                      ...(room.playerCount >= room.maxPlayers ? styles.btnJoinDisabled : {}),
                    }}
